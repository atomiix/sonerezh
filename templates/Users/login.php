<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
	<?php echo $this->Form->create(); ?>
		<fieldset>
			...
			<hr class="colorgraph"/>
            <?php echo $this->Form->control('email', array('placeholder' => __('Email Address'), 'required' => true)); ?>
			<?php echo $this->Form->control('password', array('placeholder' => __('Password'), 'required' => true)); ?>

            <?php echo $this->Form->control('remember_me', array('type' => 'checkbox', 'label' => __('Remember me'), 'divClass' => 'pull-left')); ?>
            <?php if ($settings->enable_mail_notification): ?>
...
<div class="modal fade" id="forgot-password" tabindex="-1" role="dialog" aria-labelledby="forgot-password-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo $this->Form->create(null, array('url' => array('controller' => 'users', 'action' => 'setResetPasswordToken'))); ?>
