...
<form action="<?php echo $this->Url->build(array('controller' => 'songs', 'action' => 'search')); ?>" class="navbar-form navbar-left hidden-md hidden-sm hidden-xs" role="search">
...
<ul class="nav navbar-nav navbar-right">
    ...
    <li>
        <?php echo $this->Html->image($this->Image->avatar($this->Identity->get(), 30), array('alt' => 'Avatar image', 'class' => 'img-responsive nav-tooltips', 'style' => 'padding: 10px 15px;', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => __('Hi :)'))); ?>
    </li>
</ul>
