...
<div class="modal fade" id="add-to">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php
            echo $this->Form->create(new \App\Model\Entity\PlaylistMembership(), array('url' => array('controller' => 'playlist_memberships', 'action' => 'add')));
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="input-group">
                            <?php echo $this->Form->select('id', $playlists->toArray(), array(
